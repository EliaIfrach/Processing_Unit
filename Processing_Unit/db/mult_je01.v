//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=21 LPM_WIDTHB=17 LPM_WIDTHP=38 LPM_WIDTHS=1 MAXIMIZE_SPEED=5 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
//lpm_add_sub CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48 CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" LPM_REPRESENTATION="SIGNED" LPM_WIDTH=22 dataa datab result
...
module  mult_je01
	...
	wire	[8:0]	wire_add22_result;
	wire	[31:0]	wire_add7_result;
	wire	[21:0]	wire_sum_adder1aa_0dataa;
	wire	[21:0]	wire_sum_adder1aa_0datab;
	wire	[21:0]	wire_sum_adder1aa_0result;
	wire	[21:0]	wire_sum_adder1aa_1dataa;
	wire	[21:0]	wire_sum_adder1aa_1datab;
	wire	[21:0]	wire_sum_adder1aa_1result;
	wire	[21:0]	wire_sum_adder1aa_2dataa;
	wire	[21:0]	wire_sum_adder1aa_2datab;
	wire	[21:0]	wire_sum_adder1aa_2result;
	wire	[21:0]	wire_sum_adder1aa_3dataa;
	wire	[21:0]	wire_sum_adder1aa_3datab;
	wire	[21:0]	wire_sum_adder1aa_3result;
	wire	[21:0]	wire_sum_adder1aa_4dataa;
	wire	[21:0]	wire_sum_adder1aa_4datab;
	wire	[21:0]	wire_sum_adder1aa_4result;
	wire	[21:0]	wire_sum_adder1aa_5dataa;
	wire	[21:0]	wire_sum_adder1aa_5datab;
	wire	[21:0]	wire_sum_adder1aa_5result;
	wire	[21:0]	wire_sum_adder1aa_6dataa;
	wire	[21:0]	wire_sum_adder1aa_6datab;
	wire	[21:0]	wire_sum_adder1aa_6result;
	wire	[21:0]	wire_sum_adder1aa_7dataa;
	wire	[21:0]	wire_sum_adder1aa_7datab;
	wire	[21:0]	wire_sum_adder1aa_7result;
	...
	wire  [8:0]   wire_sft23a_in;
	wire  [8:0]   wire_sft23a_out;
	wire  [8:0]   wire_sft24a_in;
	wire  [8:0]   wire_sft24a_out;
	wire  [8:0]   wire_sft25a_in;
	wire  [8:0]   wire_sft25a_out;
	wire  [8:0]   wire_sft26a_in;
	wire  [8:0]   wire_sft26a_out;
	...
	wire  [20:0]  dataa_node;
	wire  [16:0]  datab_node;
	wire  [37:0]  final_result_node;
	wire  w510w;
	wire  w535w;
	wire  [38:0]  w995w;
	wire  [356:0]  w_decoder_node9w;
	wire  [16:0]  w_le_datab_node8w;
	wire  [20:0]  w_lone_sum_node11w;
	wire  [183:0]  w_sum_node10w;
	...
	assign
		wire_sum_adder1aa_0dataa = {w_decoder_node9w[41], w_decoder_node9w[41:21]},
		wire_sum_adder1aa_0datab = {{2{w_decoder_node9w[20]}}, w_decoder_node9w[20:1]};
	assign
		wire_sum_adder1aa_1result = wire_sum_adder1aa_1dataa + wire_sum_adder1aa_1datab;
	assign
		wire_sum_adder1aa_1dataa = {w_decoder_node9w[83], w_decoder_node9w[83:63]},
		wire_sum_adder1aa_1datab = {{2{w_decoder_node9w[62]}}, w_decoder_node9w[62:43]};
	assign
		wire_sum_adder1aa_2result = wire_sum_adder1aa_2dataa + wire_sum_adder1aa_2datab;
	assign
		wire_sum_adder1aa_2dataa = {w_decoder_node9w[125], w_decoder_node9w[125:105]},
		wire_sum_adder1aa_2datab = {{2{w_decoder_node9w[104]}}, w_decoder_node9w[104:85]};
	assign
		wire_sum_adder1aa_3result = wire_sum_adder1aa_3dataa + wire_sum_adder1aa_3datab;
	assign
		wire_sum_adder1aa_3dataa = {w_decoder_node9w[167], w_decoder_node9w[167:147]},
		wire_sum_adder1aa_3datab = {{2{w_decoder_node9w[146]}}, w_decoder_node9w[146:127]};
	assign
		wire_sum_adder1aa_4result = wire_sum_adder1aa_4dataa + wire_sum_adder1aa_4datab;
	assign
		wire_sum_adder1aa_4dataa = {w_decoder_node9w[209], w_decoder_node9w[209:189]},
		wire_sum_adder1aa_4datab = {{2{w_decoder_node9w[188]}}, w_decoder_node9w[188:169]};
	assign
		wire_sum_adder1aa_5result = wire_sum_adder1aa_5dataa + wire_sum_adder1aa_5datab;
	assign
		wire_sum_adder1aa_5dataa = {w_decoder_node9w[251], w_decoder_node9w[251:231]},
		wire_sum_adder1aa_5datab = {{2{w_decoder_node9w[230]}}, w_decoder_node9w[230:211]};
	assign
		wire_sum_adder1aa_6result = wire_sum_adder1aa_6dataa + wire_sum_adder1aa_6datab;
	assign
		wire_sum_adder1aa_6dataa = {w_decoder_node9w[293], w_decoder_node9w[293:273]},
		wire_sum_adder1aa_6datab = {{2{w_decoder_node9w[272]}}, w_decoder_node9w[272:253]};
	assign
		wire_sum_adder1aa_7result = wire_sum_adder1aa_7dataa + wire_sum_adder1aa_7datab;
	assign
		wire_sum_adder1aa_7dataa = {w_decoder_node9w[335], w_decoder_node9w[335:315]},
		wire_sum_adder1aa_7datab = {{2{w_decoder_node9w[314]}}, w_decoder_node9w[314:295]};
	soft   sft10a_0
	( 
	...
	assign
		wire_sft10a_in = {w535w, {w535w, {w535w, {w535w, {w535w, {(~ w_sum_node10w[137]), {w510w, {(~ w_lone_sum_node11w[14]), {(~ w_lone_sum_node11w[13]), {w_sum_node10w[175], {w_sum_node10w[174], {w_sum_node10w[152], {w_sum_node10w[151], {wire_sft26a_out[8], {wire_sft26a_out[7], {wire_sft26a_out[6], {wire_sft26a_out[5], {wire_sft26a_out[4], {wire_sft26a_out[3], {wire_sft26a_out[2], {wire_sft26a_out[1], {wire_sft26a_out[0], {w_sum_node10w[99], {w_sum_node10w[98], {w_sum_node10w[97], {w_sum_node10w[96], {w_sum_node10w[95], {w_sum_node10w[94], {w_sum_node10w[93], {w_sum_node10w[92], {2{w535w}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft13a_in = {w535w, {w_sum_node10w[136], {(~ w_sum_node10w[114]), {w510w, {(~ w_lone_sum_node11w[12]), {(~ w_lone_sum_node11w[11]), {w_sum_node10w[173], {w_sum_node10w[172], {w_sum_node10w[150], {w_sum_node10w[149], {w_sum_node10w[127], {w_sum_node10w[126], {w_sum_node10w[125], {w_sum_node10w[124], {w_sum_node10w[123], {w_sum_node10w[122], {w_sum_node10w[121], {w_sum_node10w[120], {w_sum_node10w[119], {w_sum_node10w[118], {w_sum_node10w[117], {w_sum_node10w[116:115]}}}}}}}}}}}}}}}}}}}}}};
	soft   sft14a_0
	( 
	...
	assign
		wire_sft14a_in = {w535w, {w535w, {w535w, {w_sum_node10w[134], {w_sum_node10w[112], {w_sum_node10w[111], {w_sum_node10w[89], {w_sum_node10w[88], {w_sum_node10w[66], {w_sum_node10w[65], {w_sum_node10w[43], {w_sum_node10w[42], {w_sum_node10w[41], {w_sum_node10w[40], {w_sum_node10w[39], {w_sum_node10w[38], {w_sum_node10w[37], {w_sum_node10w[36], {w_sum_node10w[35], {w_sum_node10w[34], {w_sum_node10w[33], {w_sum_node10w[32:31]}}}}}}}}}}}}}}}}}}}}}};
	soft   sft15a_0
	( 
	...
	assign
		wire_sft15a_in = {w535w, {w535w, {w535w, {w535w, {(~ w_sum_node10w[91]), {w510w, {(~ w_lone_sum_node11w[10]), {(~ w_lone_sum_node11w[9]), {w_sum_node10w[171], {w_sum_node10w[170], {w_sum_node10w[148], {w_sum_node10w[147], {w_sum_node10w[146], {w_sum_node10w[145], {w_sum_node10w[144], {w_sum_node10w[143], {w_sum_node10w[142], {w_sum_node10w[141], {w_sum_node10w[140], {w_sum_node10w[139], {w_sum_node10w[138], {2{w535w}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft16a_0
	( 
	...
	assign
		wire_sft18a_in = {w535w, {w_sum_node10w[90], {(~ w_sum_node10w[68]), {w510w, {(~ w_lone_sum_node11w[8]), {(~ w_lone_sum_node11w[7]), {w_sum_node10w[169], {w_sum_node10w[168], {w_sum_node10w[167], {w_sum_node10w[166], {w_sum_node10w[165], {w_sum_node10w[164], {w_sum_node10w[163], {w_sum_node10w[162:161]}}}}}}}}}}}}}};
	soft   sft19a_0
	( 
	...
	assign
		wire_sft19a_in = {w535w, {w535w, {w535w, {w_sum_node10w[67], {(~ w_sum_node10w[45]), {w_sum_node10w[44], {(~ w_sum_node10w[22]), {w_sum_node10w[21], {w_sum_node10w[20], {w_sum_node10w[19], {w_sum_node10w[18], {w_sum_node10w[17], {w_sum_node10w[16], {w_sum_node10w[15:14]}}}}}}}}}}}}}};
	soft   sft20a_0
	( 
	...
	assign
		wire_sft20a_in = {w535w, {w535w, {w535w, {w535w, {w_sum_node10w[108], {w510w, {(~ w_lone_sum_node11w[6]), {(~ w_lone_sum_node11w[5]), {(~ w_lone_sum_node11w[4]), {(~ w_lone_sum_node11w[3]), {(~ w_lone_sum_node11w[2]), {(~ w_lone_sum_node11w[1]), {(~ w_lone_sum_node11w[0]), {2{w535w}}}}}}}}}}}}}}};
	soft   sft21a_0
	( 
	...
	assign
		wire_sft23a_in = {w535w, {w_sum_node10w[107], {w510w, {w_sum_node10w[84], {w_sum_node10w[83], {w_sum_node10w[82], {w_sum_node10w[81], {w_sum_node10w[80], w510w}}}}}}}};
	soft   sft24a_0
	( 
	...
	assign
		wire_sft24a_in = {w535w, {w535w, {w_sum_node10w[106], {w535w, {w535w, {w535w, {w535w, {w535w, w_sum_node10w[100]}}}}}}}};
	soft   sft25a_0
	( 
	...
	assign
		wire_sft25a_in = {w535w, {w535w, {w535w, {w535w, {w535w, {w535w, {w535w, {2{w535w}}}}}}}}};
	soft   sft26a_0
	( 
	...
	assign
		wire_sft8a_in = {w535w, {(~ w_sum_node10w[183]), {w_sum_node10w[182], {(~ w_sum_node10w[160]), {w510w, {(~ w_lone_sum_node11w[16]), {(~ w_lone_sum_node11w[15]), {w_sum_node10w[177], {w_sum_node10w[176], {w_sum_node10w[154], {w_sum_node10w[153], {w_sum_node10w[131], {w_sum_node10w[130], {w_sum_node10w[129], {w_sum_node10w[128], {w_sum_node10w[85], {w_sum_node10w[105], {w_sum_node10w[104], {w_sum_node10w[103], {w_sum_node10w[102], {w_sum_node10w[101], {w_sum_node10w[79], {w_sum_node10w[78], {w_sum_node10w[77], {w_sum_node10w[76], {w_sum_node10w[75], {w_sum_node10w[74], {w_sum_node10w[73], {w_sum_node10w[72], {w_sum_node10w[71], {w_sum_node10w[70:69]}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w535w, {w535w, {w535w, {w535w, {(~ w_lone_sum_node11w[17]), {w_sum_node10w[179], {w_sum_node10w[178], {w_sum_node10w[156], {w_sum_node10w[155], {w_sum_node10w[133], {w_sum_node10w[132], {w_sum_node10w[110], {w_sum_node10w[109], {w_sum_node10w[87], {w_sum_node10w[86], {w_sum_node10w[64], {w_sum_node10w[63], {w_sum_node10w[62], {w_sum_node10w[61], {w_sum_node10w[60], {w_sum_node10w[59], {w_sum_node10w[58], {w_sum_node10w[57], {w_sum_node10w[56], {w_sum_node10w[55], {w_sum_node10w[54], {w_sum_node10w[53], {w_sum_node10w[52], {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[49:48]}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	assign
		dataa_node = {dataa[20:0]},
		datab_node = {datab[16:0]},
		final_result_node = {w995w[37:0]},
		result = {final_result_node[37:0]},
		w510w = 1'b1,
		w535w = 1'b0,
		w995w = {wire_sft6a_out[36:35], wire_sft6a_out[34:33], wire_sft6a_out[32:31], wire_sft6a_out[30:29], wire_sft6a_out[28:27], wire_sft6a_out[26:25], wire_sft6a_out[24:23], wire_sft6a_out[22:21], wire_sft6a_out[20:19], wire_sft6a_out[18:17], wire_sft6a_out[16:15], wire_sft6a_out[14:13], wire_sft6a_out[12:11], wire_sft6a_out[10:9], wire_sft6a_out[8:7], wire_sft6a_out[6:5], wire_sft6a_out[4:3], wire_sft6a_out[2:1], wire_sft6a_out[0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[20:0]} & {21{w_le_datab_node8w[16]}}), ({dataa_node[20:0]} & {21{w_le_datab_node8w[15]}}), ({dataa_node[20:0]} & {21{w_le_datab_node8w[14]}}), ({dataa_node[20:0]} & {21{w_le_datab_node8w[13]}}), ({dataa_node[20:0]} & {21{w_le_datab_node8w[12]}}), ({dataa_node[20:0]} & {21{w_le_datab_node8w[11]}}), ({dataa_node[20:0]} & {21{w_le_datab_node8w[10]}}), ({dataa_node[20:0]} & {21{w_le_datab_node8w[9]}}), ({dataa_node[20:0]} & {21{w_le_datab_node8w[8]}}), ({dataa_node[20:0]} & {21{w_le_datab_node8w[7]}}), ({dataa_node[20:0]} & {21{w_le_datab_node8w[6]}}), ({dataa_node[20:0]} & {21{w_le_datab_node8w[5]}}), ({dataa_node[20:0]} & {21{w_le_datab_node8w[4]}}), ({dataa_node[20:0]} & {21{w_le_datab_node8w[3]}}), ({dataa_node[20:0]} & {21{w_le_datab_node8w[2]}}), ({dataa_node[20:0]} & {21{w_le_datab_node8w[1]}}), ({dataa_node[20:0]} & {21{w_le_datab_node8w[0]}})},
		w_le_datab_node8w = {datab_node[16:0]},
		w_lone_sum_node11w = {w_decoder_node9w[356:336]},
		w_sum_node10w = {wire_sum_adder1aa_7result[21:0], w_decoder_node9w[294], wire_sum_adder1aa_6result[21:0], w_decoder_node9w[252], wire_sum_adder1aa_5result[21:0], w_decoder_node9w[210], wire_sum_adder1aa_4result[21:0], w_decoder_node9w[168], wire_sum_adder1aa_3result[21:0], w_decoder_node9w[126], wire_sum_adder1aa_2result[21:0], w_decoder_node9w[84], wire_sum_adder1aa_1result[21:0], w_decoder_node9w[42], wire_sum_adder1aa_0result[21:0], w_decoder_node9w[0]};
endmodule //mult_je01
//VALID FILE
