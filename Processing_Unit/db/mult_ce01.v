//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=23 LPM_WIDTHB=17 LPM_WIDTHP=40 LPM_WIDTHS=1 MAXIMIZE_SPEED=5 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
//lpm_add_sub CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48 CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" LPM_REPRESENTATION="SIGNED" LPM_WIDTH=24 dataa datab result
...
module  mult_ce01
	...
	wire	[10:0]	wire_add22_result;
	wire	[33:0]	wire_add7_result;
	wire	[23:0]	wire_sum_adder1aa_0dataa;
	wire	[23:0]	wire_sum_adder1aa_0datab;
	wire	[23:0]	wire_sum_adder1aa_0result;
	wire	[23:0]	wire_sum_adder1aa_1dataa;
	wire	[23:0]	wire_sum_adder1aa_1datab;
	wire	[23:0]	wire_sum_adder1aa_1result;
	wire	[23:0]	wire_sum_adder1aa_2dataa;
	wire	[23:0]	wire_sum_adder1aa_2datab;
	wire	[23:0]	wire_sum_adder1aa_2result;
	wire	[23:0]	wire_sum_adder1aa_3dataa;
	wire	[23:0]	wire_sum_adder1aa_3datab;
	wire	[23:0]	wire_sum_adder1aa_3result;
	wire	[23:0]	wire_sum_adder1aa_4dataa;
	wire	[23:0]	wire_sum_adder1aa_4datab;
	wire	[23:0]	wire_sum_adder1aa_4result;
	wire	[23:0]	wire_sum_adder1aa_5dataa;
	wire	[23:0]	wire_sum_adder1aa_5datab;
	wire	[23:0]	wire_sum_adder1aa_5result;
	wire	[23:0]	wire_sum_adder1aa_6dataa;
	wire	[23:0]	wire_sum_adder1aa_6datab;
	wire	[23:0]	wire_sum_adder1aa_6result;
	wire	[23:0]	wire_sum_adder1aa_7dataa;
	wire	[23:0]	wire_sum_adder1aa_7datab;
	wire	[23:0]	wire_sum_adder1aa_7result;
	...
	wire  [16:0]   wire_sft21a_in;
	wire  [16:0]   wire_sft21a_out;
	wire  [10:0]   wire_sft23a_in;
	wire  [10:0]   wire_sft23a_out;
	wire  [10:0]   wire_sft24a_in;
	wire  [10:0]   wire_sft24a_out;
	wire  [10:0]   wire_sft25a_in;
	wire  [10:0]   wire_sft25a_out;
	wire  [10:0]   wire_sft26a_in;
	wire  [10:0]   wire_sft26a_out;
	...
	wire  [22:0]  dataa_node;
	wire  [16:0]  datab_node;
	wire  [39:0]  final_result_node;
	wire  [40:0]  w1065w;
	wire  w538w;
	wire  w565w;
	wire  [390:0]  w_decoder_node9w;
	wire  [16:0]  w_le_datab_node8w;
	wire  [22:0]  w_lone_sum_node11w;
	wire  [199:0]  w_sum_node10w;
	...
	assign
		wire_sum_adder1aa_0dataa = {w_decoder_node9w[45], w_decoder_node9w[45:23]},
		wire_sum_adder1aa_0datab = {{2{w_decoder_node9w[22]}}, w_decoder_node9w[22:1]};
	assign
		wire_sum_adder1aa_1result = wire_sum_adder1aa_1dataa + wire_sum_adder1aa_1datab;
	assign
		wire_sum_adder1aa_1dataa = {w_decoder_node9w[91], w_decoder_node9w[91:69]},
		wire_sum_adder1aa_1datab = {{2{w_decoder_node9w[68]}}, w_decoder_node9w[68:47]};
	assign
		wire_sum_adder1aa_2result = wire_sum_adder1aa_2dataa + wire_sum_adder1aa_2datab;
	assign
		wire_sum_adder1aa_2dataa = {w_decoder_node9w[137], w_decoder_node9w[137:115]},
		wire_sum_adder1aa_2datab = {{2{w_decoder_node9w[114]}}, w_decoder_node9w[114:93]};
	assign
		wire_sum_adder1aa_3result = wire_sum_adder1aa_3dataa + wire_sum_adder1aa_3datab;
	assign
		wire_sum_adder1aa_3dataa = {w_decoder_node9w[183], w_decoder_node9w[183:161]},
		wire_sum_adder1aa_3datab = {{2{w_decoder_node9w[160]}}, w_decoder_node9w[160:139]};
	assign
		wire_sum_adder1aa_4result = wire_sum_adder1aa_4dataa + wire_sum_adder1aa_4datab;
	assign
		wire_sum_adder1aa_4dataa = {w_decoder_node9w[229], w_decoder_node9w[229:207]},
		wire_sum_adder1aa_4datab = {{2{w_decoder_node9w[206]}}, w_decoder_node9w[206:185]};
	assign
		wire_sum_adder1aa_5result = wire_sum_adder1aa_5dataa + wire_sum_adder1aa_5datab;
	assign
		wire_sum_adder1aa_5dataa = {w_decoder_node9w[275], w_decoder_node9w[275:253]},
		wire_sum_adder1aa_5datab = {{2{w_decoder_node9w[252]}}, w_decoder_node9w[252:231]};
	assign
		wire_sum_adder1aa_6result = wire_sum_adder1aa_6dataa + wire_sum_adder1aa_6datab;
	assign
		wire_sum_adder1aa_6dataa = {w_decoder_node9w[321], w_decoder_node9w[321:299]},
		wire_sum_adder1aa_6datab = {{2{w_decoder_node9w[298]}}, w_decoder_node9w[298:277]};
	assign
		wire_sum_adder1aa_7result = wire_sum_adder1aa_7dataa + wire_sum_adder1aa_7datab;
	assign
		wire_sum_adder1aa_7dataa = {w_decoder_node9w[367], w_decoder_node9w[367:345]},
		wire_sum_adder1aa_7datab = {{2{w_decoder_node9w[344]}}, w_decoder_node9w[344:323]};
	soft   sft10a_0
	( 
	...
	assign
		wire_sft10a_in = {w565w, {w565w, {w565w, {w565w, {w565w, {(~ w_sum_node10w[149]), {w538w, {(~ w_lone_sum_node11w[16]), {(~ w_lone_sum_node11w[15]), {w_sum_node10w[191], {w_sum_node10w[190], {w_sum_node10w[166], {w_sum_node10w[165], {wire_sft26a_out[10], {wire_sft26a_out[9], {wire_sft26a_out[8], {wire_sft26a_out[7], {wire_sft26a_out[6], {wire_sft26a_out[5], {wire_sft26a_out[4], {wire_sft26a_out[3], {wire_sft26a_out[2], {wire_sft26a_out[1], {wire_sft26a_out[0], {w_sum_node10w[107], {w_sum_node10w[106], {w_sum_node10w[105], {w_sum_node10w[104], {w_sum_node10w[103], {w_sum_node10w[102], {w_sum_node10w[101], {w_sum_node10w[100], {2{w565w}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft13a_in = {w565w, {w_sum_node10w[148], {(~ w_sum_node10w[124]), {w538w, {(~ w_lone_sum_node11w[14]), {(~ w_lone_sum_node11w[13]), {w_sum_node10w[189], {w_sum_node10w[188], {w_sum_node10w[164], {w_sum_node10w[163], {w_sum_node10w[139], {w_sum_node10w[138], {w_sum_node10w[137], {w_sum_node10w[136], {w_sum_node10w[135], {w_sum_node10w[134], {w_sum_node10w[133], {w_sum_node10w[132], {w_sum_node10w[131], {w_sum_node10w[130], {w_sum_node10w[129], {w_sum_node10w[128], {w_sum_node10w[127], {w_sum_node10w[126:125]}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft14a_0
	( 
	...
	assign
		wire_sft14a_in = {w565w, {w565w, {w565w, {w_sum_node10w[146], {w_sum_node10w[122], {w_sum_node10w[121], {w_sum_node10w[97], {w_sum_node10w[96], {w_sum_node10w[72], {w_sum_node10w[71], {w_sum_node10w[47], {w_sum_node10w[46], {w_sum_node10w[45], {w_sum_node10w[44], {w_sum_node10w[43], {w_sum_node10w[42], {w_sum_node10w[41], {w_sum_node10w[40], {w_sum_node10w[39], {w_sum_node10w[38], {w_sum_node10w[37], {w_sum_node10w[36], {w_sum_node10w[35], {w_sum_node10w[34:33]}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft15a_0
	( 
	...
	assign
		wire_sft15a_in = {w565w, {w565w, {w565w, {w565w, {(~ w_sum_node10w[99]), {w538w, {(~ w_lone_sum_node11w[12]), {(~ w_lone_sum_node11w[11]), {w_sum_node10w[187], {w_sum_node10w[186], {w_sum_node10w[162], {w_sum_node10w[161], {w_sum_node10w[160], {w_sum_node10w[159], {w_sum_node10w[158], {w_sum_node10w[157], {w_sum_node10w[156], {w_sum_node10w[155], {w_sum_node10w[154], {w_sum_node10w[153], {w_sum_node10w[152], {w_sum_node10w[151], {w_sum_node10w[150], {2{w565w}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft16a_0
	( 
	...
	assign
		wire_sft18a_in = {w565w, {w_sum_node10w[98], {(~ w_sum_node10w[74]), {w538w, {(~ w_lone_sum_node11w[10]), {(~ w_lone_sum_node11w[9]), {w_sum_node10w[185], {w_sum_node10w[184], {w_sum_node10w[183], {w_sum_node10w[182], {w_sum_node10w[181], {w_sum_node10w[180], {w_sum_node10w[179], {w_sum_node10w[178], {w_sum_node10w[177], {w_sum_node10w[176:175]}}}}}}}}}}}}}}}};
	soft   sft19a_0
	( 
	...
	assign
		wire_sft19a_in = {w565w, {w565w, {w565w, {w_sum_node10w[73], {(~ w_sum_node10w[49]), {w_sum_node10w[48], {(~ w_sum_node10w[24]), {w_sum_node10w[23], {w_sum_node10w[22], {w_sum_node10w[21], {w_sum_node10w[20], {w_sum_node10w[19], {w_sum_node10w[18], {w_sum_node10w[17], {w_sum_node10w[16], {w_sum_node10w[15:14]}}}}}}}}}}}}}}}};
	soft   sft20a_0
	( 
	...
	assign
		wire_sft20a_in = {w565w, {w565w, {w565w, {w565w, {w_sum_node10w[118], {w538w, {(~ w_lone_sum_node11w[8]), {(~ w_lone_sum_node11w[7]), {(~ w_lone_sum_node11w[6]), {(~ w_lone_sum_node11w[5]), {(~ w_lone_sum_node11w[4]), {(~ w_lone_sum_node11w[3]), {(~ w_lone_sum_node11w[2]), {(~ w_lone_sum_node11w[1]), {(~ w_lone_sum_node11w[0]), {2{w565w}}}}}}}}}}}}}}}}};
	soft   sft21a_0
	( 
	...
	assign
		wire_sft23a_in = {w565w, {w_sum_node10w[117], {w538w, {w_sum_node10w[92], {w_sum_node10w[91], {w_sum_node10w[90], {w_sum_node10w[89], {w_sum_node10w[88], {w_sum_node10w[87], {w_sum_node10w[86], w538w}}}}}}}}}};
	soft   sft24a_0
	( 
	...
	assign
		wire_sft24a_in = {w565w, {w565w, {w_sum_node10w[116], {w565w, {w565w, {w565w, {w565w, {w565w, {w565w, {w565w, w_sum_node10w[108]}}}}}}}}}};
	soft   sft25a_0
	( 
	...
	assign
		wire_sft25a_in = {w565w, {w565w, {w565w, {w565w, {w565w, {w565w, {w565w, {w565w, {w565w, {2{w565w}}}}}}}}}}};
	soft   sft26a_0
	( 
	...
	assign
		wire_sft4a_in = {w565w, {w565w, {w_lone_sum_node11w[22], {(~ w_lone_sum_node11w[21]), {w_sum_node10w[197], {w_sum_node10w[196], {wire_sft11a_out[28], {wire_sft11a_out[27], {wire_sft11a_out[26], {wire_sft11a_out[25], {wire_sft16a_out[20], {wire_sft16a_out[19], {wire_sft16a_out[18], {wire_sft16a_out[17], {wire_sft16a_out[16], {wire_sft16a_out[15], {wire_sft16a_out[14], {wire_sft16a_out[13], {wire_sft16a_out[12], {wire_sft16a_out[11], {wire_sft16a_out[10], {wire_sft16a_out[9], {wire_sft16a_out[8], {wire_sft16a_out[7], {wire_sft16a_out[6], {wire_sft16a_out[5], {wire_sft16a_out[4], {wire_sft11a_out[7], {wire_sft11a_out[6], {wire_sft11a_out[5], {wire_sft11a_out[4], {w_sum_node10w[32], {w_sum_node10w[31], {w_sum_node10w[30], {w_sum_node10w[29], {w_sum_node10w[28], {w_sum_node10w[27], {w_sum_node10w[26:25]}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft8a_in = {w565w, {(~ w_sum_node10w[199]), {w_sum_node10w[198], {(~ w_sum_node10w[174]), {w538w, {(~ w_lone_sum_node11w[18]), {(~ w_lone_sum_node11w[17]), {w_sum_node10w[193], {w_sum_node10w[192], {w_sum_node10w[168], {w_sum_node10w[167], {w_sum_node10w[143], {w_sum_node10w[142], {w_sum_node10w[141], {w_sum_node10w[140], {w_sum_node10w[93], {w_sum_node10w[115], {w_sum_node10w[114], {w_sum_node10w[113], {w_sum_node10w[112], {w_sum_node10w[111], {w_sum_node10w[110], {w_sum_node10w[109], {w_sum_node10w[85], {w_sum_node10w[84], {w_sum_node10w[83], {w_sum_node10w[82], {w_sum_node10w[81], {w_sum_node10w[80], {w_sum_node10w[79], {w_sum_node10w[78], {w_sum_node10w[77], {w_sum_node10w[76:75]}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w565w, {w565w, {w565w, {w565w, {(~ w_lone_sum_node11w[19]), {w_sum_node10w[195], {w_sum_node10w[194], {w_sum_node10w[170], {w_sum_node10w[169], {w_sum_node10w[145], {w_sum_node10w[144], {w_sum_node10w[120], {w_sum_node10w[119], {w_sum_node10w[95], {w_sum_node10w[94], {w_sum_node10w[70], {w_sum_node10w[69], {w_sum_node10w[68], {w_sum_node10w[67], {w_sum_node10w[66], {w_sum_node10w[65], {w_sum_node10w[64], {w_sum_node10w[63], {w_sum_node10w[62], {w_sum_node10w[61], {w_sum_node10w[60], {w_sum_node10w[59], {w_sum_node10w[58], {w_sum_node10w[57], {w_sum_node10w[56], {w_sum_node10w[55], {w_sum_node10w[54], {w_sum_node10w[53:52]}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	assign
		dataa_node = {dataa[22:0]},
		datab_node = {datab[16:0]},
		final_result_node = {w1065w[39:0]},
		result = {final_result_node[39:0]},
		w1065w = {wire_sft6a_out[38:37], wire_sft6a_out[36:35], wire_sft6a_out[34:33], wire_sft6a_out[32:31], wire_sft6a_out[30:29], wire_sft6a_out[28:27], wire_sft6a_out[26:25], wire_sft6a_out[24:23], wire_sft6a_out[22:21], wire_sft6a_out[20:19], wire_sft6a_out[18:17], wire_sft6a_out[16:15], wire_sft6a_out[14:13], wire_sft6a_out[12:11], wire_sft6a_out[10:9], wire_sft6a_out[8:7], wire_sft6a_out[6:5], wire_sft6a_out[4:3], wire_sft6a_out[2:1], wire_sft6a_out[0], w_sum_node10w[1], w_sum_node10w[0]},
		w538w = 1'b1,
		w565w = 1'b0,
		w_decoder_node9w = {({dataa_node[22:0]} & {23{w_le_datab_node8w[16]}}), ({dataa_node[22:0]} & {23{w_le_datab_node8w[15]}}), ({dataa_node[22:0]} & {23{w_le_datab_node8w[14]}}), ({dataa_node[22:0]} & {23{w_le_datab_node8w[13]}}), ({dataa_node[22:0]} & {23{w_le_datab_node8w[12]}}), ({dataa_node[22:0]} & {23{w_le_datab_node8w[11]}}), ({dataa_node[22:0]} & {23{w_le_datab_node8w[10]}}), ({dataa_node[22:0]} & {23{w_le_datab_node8w[9]}}), ({dataa_node[22:0]} & {23{w_le_datab_node8w[8]}}), ({dataa_node[22:0]} & {23{w_le_datab_node8w[7]}}), ({dataa_node[22:0]} & {23{w_le_datab_node8w[6]}}), ({dataa_node[22:0]} & {23{w_le_datab_node8w[5]}}), ({dataa_node[22:0]} & {23{w_le_datab_node8w[4]}}), ({dataa_node[22:0]} & {23{w_le_datab_node8w[3]}}), ({dataa_node[22:0]} & {23{w_le_datab_node8w[2]}}), ({dataa_node[22:0]} & {23{w_le_datab_node8w[1]}}), ({dataa_node[22:0]} & {23{w_le_datab_node8w[0]}})},
		w_le_datab_node8w = {datab_node[16:0]},
		w_lone_sum_node11w = {w_decoder_node9w[390:368]},
		w_sum_node10w = {wire_sum_adder1aa_7result[23:0], w_decoder_node9w[322], wire_sum_adder1aa_6result[23:0], w_decoder_node9w[276], wire_sum_adder1aa_5result[23:0], w_decoder_node9w[230], wire_sum_adder1aa_4result[23:0], w_decoder_node9w[184], wire_sum_adder1aa_3result[23:0], w_decoder_node9w[138], wire_sum_adder1aa_2result[23:0], w_decoder_node9w[92], wire_sum_adder1aa_1result[23:0], w_decoder_node9w[46], wire_sum_adder1aa_0result[23:0], w_decoder_node9w[0]};
endmodule //mult_ce01
//VALID FILE
