//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=24 LPM_WIDTHB=16 LPM_WIDTHP=40 LPM_WIDTHS=1 MAXIMIZE_SPEED=5 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
//lpm_add_sub CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48 CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" LPM_REPRESENTATION="SIGNED" LPM_WIDTH=25 dataa datab result
...
//lpm_add_sub CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48 CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" LPM_REPRESENTATION="SIGNED" LPM_WIDTH=25 cin dataa datab result
//VERSION_BEGIN 17.0 cbx_cycloneii 2017:04:25:18:06:29:SJ cbx_lpm_add_sub 2017:04:25:18:06:29:SJ cbx_mgl 2017:04:25:18:09:28:SJ cbx_nadder 2017:04:25:18:06:30:SJ cbx_stratix 2017:04:25:18:06:30:SJ cbx_stratixii 2017:04:25:18:06:30:SJ  VERSION_END

//synthesis_resources = lut 422 
...
module  mult_be01
	...
	wire	[25:0]	wire_sum_adder1aa_7result_int;
	...
	wire  [15:0]   wire_sft18a_in;
	wire  [15:0]   wire_sft18a_out;
	wire  [15:0]   wire_sft19a_in;
	wire  [15:0]   wire_sft19a_out;
	wire  [15:0]   wire_sft20a_in;
	wire  [15:0]   wire_sft20a_out;
	wire  [15:0]   wire_sft21a_in;
	wire  [15:0]   wire_sft21a_out;
	...
	assign
		wire_sum_adder1aa_0dataa = {w_decoder_node9w[47], w_decoder_node9w[47:24]},
		wire_sum_adder1aa_0datab = {{2{w_decoder_node9w[23]}}, w_decoder_node9w[23:1]};
	assign
		wire_sum_adder1aa_1result = wire_sum_adder1aa_1dataa + wire_sum_adder1aa_1datab;
	assign
		wire_sum_adder1aa_1dataa = {w_decoder_node9w[95], w_decoder_node9w[95:72]},
		wire_sum_adder1aa_1datab = {{2{w_decoder_node9w[71]}}, w_decoder_node9w[71:49]};
	assign
		wire_sum_adder1aa_2result = wire_sum_adder1aa_2dataa + wire_sum_adder1aa_2datab;
	assign
		wire_sum_adder1aa_2dataa = {w_decoder_node9w[143], w_decoder_node9w[143:120]},
		wire_sum_adder1aa_2datab = {{2{w_decoder_node9w[119]}}, w_decoder_node9w[119:97]};
	assign
		wire_sum_adder1aa_3result = wire_sum_adder1aa_3dataa + wire_sum_adder1aa_3datab;
	assign
		wire_sum_adder1aa_3dataa = {w_decoder_node9w[191], w_decoder_node9w[191:168]},
		wire_sum_adder1aa_3datab = {{2{w_decoder_node9w[167]}}, w_decoder_node9w[167:145]};
	assign
		wire_sum_adder1aa_4result = wire_sum_adder1aa_4dataa + wire_sum_adder1aa_4datab;
	assign
		wire_sum_adder1aa_4dataa = {w_decoder_node9w[239], w_decoder_node9w[239:216]},
		wire_sum_adder1aa_4datab = {{2{w_decoder_node9w[215]}}, w_decoder_node9w[215:193]};
	assign
		wire_sum_adder1aa_5result = wire_sum_adder1aa_5dataa + wire_sum_adder1aa_5datab;
	assign
		wire_sum_adder1aa_5dataa = {w_decoder_node9w[287], w_decoder_node9w[287:264]},
		wire_sum_adder1aa_5datab = {{2{w_decoder_node9w[263]}}, w_decoder_node9w[263:241]};
	assign
		wire_sum_adder1aa_6result = wire_sum_adder1aa_6dataa + wire_sum_adder1aa_6datab;
	assign
		wire_sum_adder1aa_6dataa = {w_decoder_node9w[335], w_decoder_node9w[335:312]},
		wire_sum_adder1aa_6datab = {{2{w_decoder_node9w[311]}}, w_decoder_node9w[311:289]};
	assign
	...
	assign
		wire_sum_adder1aa_7result = wire_sum_adder1aa_7result_int[25:1];
	assign
		wire_sum_adder1aa_7cin = 1'b1,
		wire_sum_adder1aa_7dataa = {(~ w_decoder_node9w[383]), (~ w_decoder_node9w[383:360])},
		wire_sum_adder1aa_7datab = {{2{w_decoder_node9w[359]}}, w_decoder_node9w[359:337]};
	soft   sft10a_0
	( 
	...
	assign
		wire_sft10a_in = {w509w, {w509w, {w509w, {w509w, {(~ w_sum_node10w[129]), {w495w, {w_sum_node10w[199], {w_sum_node10w[198], {w_sum_node10w[173], {w_sum_node10w[172], {w_sum_node10w[147], {w_sum_node10w[146], {w_sum_node10w[121], {w_sum_node10w[120], {w_sum_node10w[119], {w_sum_node10w[118], {w_sum_node10w[117], {w_sum_node10w[116], {w_sum_node10w[115], {w_sum_node10w[114], {w_sum_node10w[113], {w_sum_node10w[112], {w_sum_node10w[111], {w_sum_node10w[110], {w_sum_node10w[109], {w_sum_node10w[108], {w_sum_node10w[107], {w_sum_node10w[106], {w_sum_node10w[105], {w_sum_node10w[104], {2{w509w}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft15a_in = {w509w, {w509w, {w509w, {w509w, {(~ w_sum_node10w[77]), {w495w, {w_sum_node10w[195], {w_sum_node10w[194], {w_sum_node10w[169], {w_sum_node10w[168], {w_sum_node10w[167], {w_sum_node10w[166], {w_sum_node10w[165], {w_sum_node10w[164], {w_sum_node10w[163], {w_sum_node10w[162], {w_sum_node10w[161], {w_sum_node10w[160], {w_sum_node10w[159], {w_sum_node10w[158], {w_sum_node10w[157], {w_sum_node10w[156], {2{w509w}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft16a_0
	( 
	...
	assign
		wire_sft18a_in = {w509w, {w_sum_node10w[76], {(~ w_sum_node10w[51]), {w495w, {w_sum_node10w[193], {w_sum_node10w[192], {w_sum_node10w[191], {w_sum_node10w[190], {w_sum_node10w[189], {w_sum_node10w[188], {w_sum_node10w[187], {w_sum_node10w[186], {w_sum_node10w[185], {w_sum_node10w[184], {w_sum_node10w[183:182]}}}}}}}}}}}}}}};
	soft   sft19a_0
	( 
	...
	assign
		wire_sft19a_in = {w509w, {w509w, {w509w, {w_sum_node10w[50], {(~ w_sum_node10w[25]), {w_sum_node10w[24], {w_sum_node10w[23], {w_sum_node10w[22], {w_sum_node10w[21], {w_sum_node10w[20], {w_sum_node10w[19], {w_sum_node10w[18], {w_sum_node10w[17], {w_sum_node10w[16], {w_sum_node10w[15:14]}}}}}}}}}}}}}}};
	soft   sft20a_0
	( 
	...
	assign
		wire_sft20a_in = {w509w, {w509w, {w509w, {w509w, {w495w, {w509w, {w509w, {w509w, {w509w, {w509w, {w509w, {w509w, {w509w, {w509w, {2{w509w}}}}}}}}}}}}}}}};
	soft   sft21a_0
	( 
	...
	assign
		wire_sft9a_in = {w509w, {w509w, {w509w, {w_sum_node10w[202], {w_sum_node10w[177], {w_sum_node10w[176], {w_sum_node10w[151], {w_sum_node10w[150], {w_sum_node10w[125], {w_sum_node10w[124], {w_sum_node10w[99], {w_sum_node10w[98], {w_sum_node10w[73], {w_sum_node10w[72], {w_sum_node10w[71], {w_sum_node10w[70], {w_sum_node10w[69], {w_sum_node10w[68], {w_sum_node10w[67], {w_sum_node10w[66], {w_sum_node10w[65], {w_sum_node10w[64], {w_sum_node10w[63], {w_sum_node10w[62], {w_sum_node10w[61], {w_sum_node10w[60], {w_sum_node10w[59], {w_sum_node10w[58], {w_sum_node10w[57], {w_sum_node10w[56], {w_sum_node10w[55:54]}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	assign
		dataa_node = {dataa[23:0]},
		datab_node = {datab[15:0]},
		final_result_node = {w952w[39:0]},
		result = {final_result_node[39:0]},
		w495w = 1'b1,
		w509w = 1'b0,
		w952w = {wire_sft6a_out[38:37], wire_sft6a_out[36:35], wire_sft6a_out[34:33], wire_sft6a_out[32:31], wire_sft6a_out[30:29], wire_sft6a_out[28:27], wire_sft6a_out[26:25], wire_sft6a_out[24:23], wire_sft6a_out[22:21], wire_sft6a_out[20:19], wire_sft6a_out[18:17], wire_sft6a_out[16:15], wire_sft6a_out[14:13], wire_sft6a_out[12:11], wire_sft6a_out[10:9], wire_sft6a_out[8:7], wire_sft6a_out[6:5], wire_sft6a_out[4:3], wire_sft6a_out[2:1], wire_sft6a_out[0], w_sum_node10w[1], w_sum_node10w[0]},
